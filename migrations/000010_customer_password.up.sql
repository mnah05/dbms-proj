...
-- SECURITY WARNING: This is a hardcoded default password hash for existing customers
-- Password: "changeme" - Customers MUST change this password immediately after first login
-- In production, force password reset or use a more secure migration strategy
